...
export default function ComponentCard({
  ...
  return (
    <div
      className={`p-6 group relative rounded-xl w-full max-w-3xl transition-all duration-500 
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2 mb-3">
          <h3 className="text-lg md:text-xl font-bold text-gray-900 group-hover:text-black transition-colors duration-300 font-mono">
            {title}
          </h3>

          {isComingSoon && (
            <span className="px-2 py-1 bg-gray-200 text-gray-700 text-xs md:text-sm font-medium rounded-full border border-gray-300 self-start sm:self-auto">
              Coming Soon
            </span>
          )}
        </div>
        ...
        <Textfit
          ...
          min={10}
          max={15}
          className="text-gray-700 leading-relaxed pt-3 pb-3 font-medium font-mono"
        >
          {description}
        </Textfit>
        ...
        <div className="rounded-lg border border-gray-300/60 group-hover:border-gray-400/80 overflow-hidden transition-all duration-300">
          ...
          <div className="flex items-center bg-black min-h-[2.5rem]">
            <div className="flex-1 min-w-0">
              <pre className="text-gray-100 font-mono text-[11px] sm:text-[14px] md:text-[13px] font-semibold px-3 py-2 truncate">
